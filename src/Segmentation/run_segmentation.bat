...
set root_dir=C:\\Users\\Codex\\Documents\\Segmentation
set images_dir=C:\\Users\\Codex\\Documents\\Segmentation\\input_images
if "%3"=="" (
    echo "using default MaskRCNN folder: %root_dir%\Mask_RCNN-2.1"
    set "pathToInsert=%root_dir%\Mask_RCNN-2.1"
) else (
    set pathToInsert=C:\\Users\\Codex\\Documents\\Segmentstion\\Mask_RCNN
)
...
python %maskrcnn_scripts%\\segmentation_manualsize.py %maskrcnn%\config\predict\presegment_manualsize.json
IF %ERRORLEVEL% NEQ 0 (
